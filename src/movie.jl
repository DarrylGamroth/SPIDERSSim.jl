"""
    spiders_movie(wavelength_m, ao_residuals_nm; gridsize=1024,
                  config=SpidersConfig(), final_sampling_m=11.513e-6)
...
"""
function spiders_movie(
    wavelength_m::Real,
    ao_residuals_nm::AbstractArray{<:Real,3};
    gridsize::Integer=1024,
    config::SpidersConfig=SpidersConfig(reference_pinhole=true),
    ao_sampling_m::Real=0.045 / 7.73 * config.telescope_diameter_m,
